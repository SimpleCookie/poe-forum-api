...
export const getCategoriesSchemaV4 = {
  tags: ['Categories - V4'],
  description: 'Get all available forum categories (V4)',
  response: {
    200: {
      type: 'object',
      required: ['poe1', 'poe2'],
...
export const getCategorySchemaV4 = {
  tags: ['Categories - V4'],
  description: 'Get threads from a category (V4)',
  params: {
    type: 'object',
    properties: {
