...
export const getCategoriesSchemaV5 = {
  tags: ['Categories - V5'],
  description: 'Get all available forum categories (V5)',
  response: {
    200: {
      type: 'object',
      required: ['poe1', 'poe2'],
...
export const getCategorySchemaV5 = {
  tags: ['Categories - V5'],
  description: 'Get threads from a category (V5)',
  params: {
    type: 'object',
    properties: {
